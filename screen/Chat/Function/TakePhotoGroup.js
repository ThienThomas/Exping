...
import { compressImage, SendImgMess, SendImgMessGroup } from '../../../mymodules/CompressImg';
import AsyncStorageLib from '@react-native-async-storage/async-storage';
let camera = Camera
export default function TakePhotoGroup({route}) {
      ...
      {startCamera ? (
        < >
          {previewVisible && capturedImage ? (
            <CameraPreview photo={capturedImage} savePhoto={__savePhoto} retakePicture={__retakePicture} groupid={groupid}/>
          ) : (
            <Camera
              type={cameraType}
              flashMode={flashMode}
...
const CameraPreview = ({photo, retakePicture, savePhoto, groupid}) => {
  ...
  //console.log(groupid)
    ...
    await SendImgMessGroup(groupid, compressed)
    navigation.goBack()
  }
  return (
    <View
