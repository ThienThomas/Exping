...
import { SendAudioMess } from "../../../mymodules/CompressImg";
const loadinganimation = require('../../../assets/json/recordingaudio.json')
export default function RecordAudio({audioRef,audioplayerRef,  user, fremail}) {
    ...
    async function UploadMyAudio(){
        if (recordedURI) {
            ...
            const result = await SendAudioMess(token, email, fremail, recordedURI)
        }
    }
